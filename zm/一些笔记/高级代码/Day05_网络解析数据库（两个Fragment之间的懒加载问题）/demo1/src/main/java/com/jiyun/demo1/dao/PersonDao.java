...
public class PersonDao extends AbstractDao<Person, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Tel = new Property(3, Long.class, "tel", false, "TEL");
    ...
    public Person readEntity(Cursor cursor, int offset) {
        Person entity = new Person( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3), // tel
    ...
    public void readEntity(Cursor cursor, Person entity, int offset) {
        ...
        entity.setTel(cursor.isNull(offset + 3) ? null : cursor.getLong(offset + 3));
