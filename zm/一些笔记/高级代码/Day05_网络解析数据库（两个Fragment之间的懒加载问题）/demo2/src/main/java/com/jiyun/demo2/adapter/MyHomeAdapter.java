...
public class MyHomeAdapter extends RecyclerView.Adapter<MyHomeAdapter.ViewHolder> {
    ...
    public void setList(ArrayList<ListBean.ResultBean> list) {
        this.list = list;
    }

    public MyHomeAdapter(Context context, ArrayList<ListBean.ResultBean> list) {
    ...
    public interface OnClickListener{
        void onItemClick(int position,ListBean.ResultBean resultBean);
    }
}
