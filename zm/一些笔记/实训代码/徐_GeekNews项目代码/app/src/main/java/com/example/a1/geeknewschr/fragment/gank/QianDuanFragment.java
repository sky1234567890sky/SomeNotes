 ...
 */
public class QianDuanFragment extends BaseFragment<IsoV,IsoP> implements IsoV {


    @BindView(R.id.rl_qianduan)
    RecyclerView mRlQianduan;
    private ArrayList<IsoBean.ResultsBean> mIsoList;
    private RlIsoAdapter mRlIsoAdapter;

    public String teach = "前端";
    public int num = 10;
    public int page = 1;
    ...
    protected int getLayoutId() {
        return R.layout.fragment_qian_duan;
    }
    @Override
    protected void initView() {
        ...
        mRlQianduan.setAdapter(mRlIsoAdapter);
        mRlQianduan.setLayoutManager(new LinearLayoutManager(getActivity()));
    }
