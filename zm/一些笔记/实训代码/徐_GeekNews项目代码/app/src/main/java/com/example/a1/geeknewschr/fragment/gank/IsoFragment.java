 ...
 */
public class IsoFragment extends BaseFragment<IsoV, IsoP> implements IsoV {
    ...
    protected void initView() {
        ...
        mRlIso.setAdapter(mRlIsoAdapter);
        mRlIso.setLayoutManager(new LinearLayoutManager(getActivity()));
    }
