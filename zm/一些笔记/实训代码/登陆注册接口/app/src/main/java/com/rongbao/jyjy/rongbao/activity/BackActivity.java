...
public class BackActivity extends BaseActivity<BasePresent,BaseView> implements BaseView {
        ...
        mFramentMaptvSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(content)) {
                    Toast.makeText(BackActivity.this, "输入要搜索的东西", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void routeWalkPlanWithParam(LatLng end) {
        ...
        WalkNavigateHelper.getInstance().routePlanWithParams(mParam, new IWRoutePlanListener() {
            ...
            public void onRoutePlanSuccess() {
               ...
               startActivity(new Intent(BackActivity.this, WNaviGuideActivity.class));
