...
-- 常用属性：
    android:src：设置ImageView所显示的Drawable对象id。
    android:scaleType：设置图片资源显示具体填充效果的，值有好几种，分别
    为matrix、center、centerCrop 、centerInside、fitCenter、fitEnd、fitStart、fitXY、
